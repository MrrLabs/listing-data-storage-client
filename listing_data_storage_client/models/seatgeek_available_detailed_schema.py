...
class SeatgeekAvailableDetailedSchema(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["listing_id", "section", "row", "slug", "row_rank", "seat", "seat_rank", "quantity", "ticket_price", "fee", "total_price", "deal_score", "delivery_type", "notes", "description", "inserted"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SeatgeekAvailableDetailedSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SeatgeekAvailableDetailedSchema from a dict"""
        if obj is None:
            return None
