...
class TixrUpdateSeatStoreSchema(BaseModel):
    """
    TixrUpdateSeatStoreSchema
    """ # noqa: E501
    add_place: List[TixrPriceStoreSchema] = Field(alias="addPlace")
    remove_place: List[StrictStr] = Field(alias="removePlace")
    update_place: List[TixrPriceStoreSchema] = Field(alias="updatePlace")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TixrUpdateSeatStoreSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TixrUpdateSeatStoreSchema from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "addPlace": [TixrPriceStoreSchema.from_dict(_item) for _item in obj["addPlace"]] if obj.get("addPlace") is not None else None,
            "removePlace": obj.get("removePlace"),
            "updatePlace": [TixrPriceStoreSchema.from_dict(_item) for _item in obj["updatePlace"]] if obj.get("updatePlace") is not None else None,
