...
class TixrStoreRequestSchema(BaseModel):
    """
    ...
    update: Optional[TixrUpdateSeatStoreSchema] = None
    seats: List[TixrStoreSchema]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TixrStoreRequestSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TixrStoreRequestSchema from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "update": TixrUpdateSeatStoreSchema.from_dict(obj["update"]) if obj.get("update") is not None else None,
            "seats": [TixrStoreSchema.from_dict(_item) for _item in obj["seats"]] if obj.get("seats") is not None else None
        })
        return _obj
