...
class SeatgeekStoreRequestSchema(BaseModel):
    """
    ...
    update: Optional[SeatgeekUpdateSeatStoreSchema] = None
    seats: List[SeatgeekStoreSchema]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SeatgeekStoreRequestSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SeatgeekStoreRequestSchema from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "update": SeatgeekUpdateSeatStoreSchema.from_dict(obj["update"]) if obj.get("update") is not None else None,
            "seats": [SeatgeekStoreSchema.from_dict(_item) for _item in obj["seats"]] if obj.get("seats") is not None else None
        })
        return _obj
